...
export default function Hero() {
  return (
    <div className="bg-[url(/images/hero.jpg)] bg-gray-200 bg-blend-multiply h-[95vh] bg-center bg-cover">
      <div className="w-full h-full overflow-hidden relative uppercase flex items-center justify-center flex-col gap-10">
        <h2 className=" select-none text-white  text-9xl font-light">La Princesse</h2>
